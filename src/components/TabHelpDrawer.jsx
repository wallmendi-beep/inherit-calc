...
const HELP_TOPICS = {
  input: {
    ...
    sections: [
      ...
      {
        title: 'AI 입력 방법과 주의사항',
        body: [
          'AI 입력은 완성된 계산 결과가 아니라 입력 초안을 만드는 기능입니다. AI 입력 후에는 반드시 데이터 입력 탭에서 내용을 검토해야 합니다.',
        ],
        bullets: [
          '이름, 관계, 사망일자가 맞는지 확인합니다.',
          '사망자 아래 하위 상속인이 누락되지 않았는지 확인합니다.',
          '같은 단계에 배우자가 중복으로 들어가지 않았는지 확인합니다.',
          '후혼 배우자나 후혼 자녀가 특정 사건 상속인 범위에 잘못 섞이지 않았는지 확인합니다.',
          '구법 사건에서는 혼인일, 복적일, 동일가적·비동일가적, 호주 여부를 확인합니다.',
        ],
        note: '사용자가 직접 수정한 값이 AI가 만든 값보다 우선합니다.',
      },
    ],
    checklist: [
