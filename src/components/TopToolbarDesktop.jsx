...
export default function TopToolbarDesktop({
  sidebarOpen,
  setSidebarOpen,
  tree,
  setAiTargetId,
      ...
      <div className="w-[1080px] min-w-[1080px] shrink-0 px-6 flex items-center justify-between h-full flex-nowrap">
        ...
        <div className="flex items-center gap-1.5 shrink-0" ref={menuRef}>
          ...
          <div className="relative">
            <button onClick={() => toggleMenu('file')} className="text-[#787774] hover:text-[#37352f] hover:bg-[#efefed] px-2.5 py-1 rounded border border-transparent hover:border-[#d4d4d4] text-[12px] font-bold transition-colors flex items-center gap-1">
            ...
            {openMenu === 'file' && (
              <div className="absolute right-0 top-9 w-36 rounded-xl border border-[#e9e9e7] dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-xl p-1.5 flex flex-col gap-1 z-[120]">
                ...
                <button onClick={() => { closeMenus(); saveFile(); }} className="px-2.5 py-2 rounded-lg text-[12px] font-bold text-[#37352f] dark:text-neutral-200 hover:bg-[#f7f7f5] dark:hover:bg-neutral-700 flex items-center gap-2">
                  <IconSave className="h-3.5 w-3.5" /> 저장
                </button>
                <button onClick={() => { closeMenus(); setIsResetModalOpen(true); }} className="px-2.5 py-2 rounded-lg text-[12px] font-bold text-[#d44c47] hover:bg-[#fff1ef] dark:hover:bg-red-900/20 flex items-center gap-2">
          ...
          <div className="relative">
            <button onClick={() => toggleMenu('export')} className="text-[#787774] hover:text-[#37352f] hover:bg-[#efefed] px-2.5 py-1 rounded border border-transparent hover:border-[#d4d4d4] text-[12px] font-bold transition-colors flex items-center gap-1">
            ...
            {openMenu === 'export' && (
              <div className="absolute right-0 top-9 w-32 rounded-xl border border-[#e9e9e7] dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-xl p-1.5 flex flex-col gap-1 z-[120]">
                <button onClick={() => { closeMenus(); handlePrint(); }} className="px-2.5 py-2 rounded-lg text-[12px] font-bold text-[#37352f] dark:text-neutral-200 hover:bg-[#f7f7f5] dark:hover:bg-neutral-700 flex items-center gap-2">
                  <IconPrinter className="h-3.5 w-3.5" /> 인쇄
                </button>
                <button onClick={() => { closeMenus(); handleExcelExport(); }} className="px-2.5 py-2 rounded-lg text-[12px] font-bold text-[#37352f] dark:text-neutral-200 hover:bg-[#f7f7f5] dark:hover:bg-neutral-700 flex items-center gap-2">
          ...
          <div className="relative">
            <button onClick={() => toggleMenu('view')} className="text-[#787774] hover:text-[#37352f] hover:bg-[#efefed] px-2.5 py-1 rounded border border-transparent hover:border-[#d4d4d4] text-[12px] font-bold transition-colors flex items-center gap-1">
            ...
            {openMenu === 'view' && (
              <div className="absolute right-0 top-9 w-36 rounded-xl border border-[#e9e9e7] dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-xl p-1.5 flex flex-col gap-1 z-[120]">
                ...
                <button onClick={() => { closeMenus(); setIsDarkMode(!isDarkMode); }} className="px-2.5 py-2 rounded-lg text-[12px] font-bold text-[#37352f] dark:text-neutral-200 hover:bg-[#f7f7f5] dark:hover:bg-neutral-700 flex items-center gap-2">
