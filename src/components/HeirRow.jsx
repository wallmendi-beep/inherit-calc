            ...
            {isSpouseType && (() => {
              ...
              return (
                <div className="flex items-center gap-1.5 shrink-0">
                  ...
                  {multiplier && (
                    <span className={`px-2 py-0.5 rounded-full border bg-white text-[10px] font-medium shadow-sm whitespace-nowrap ${multiplier.includes('/') ? 'border-rose-800/80 text-rose-800/80' : 'border-neutral-300 text-[#37352f]'}`}>
                      {multiplier}
                    </span>
                  )}
                </div>
