...
export default function MetaHeader({ tree }) {
  return (
    <div className="w-full mb-6 pb-3 border-b border-[#e9e9e7] dark:border-neutral-600 text-[13px] text-[#504f4c] dark:text-neutral-300 flex flex-wrap gap-8 no-print">
